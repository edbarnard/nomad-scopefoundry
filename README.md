...
NOMAD schemas and parsers for ScopeFoundry HDF5 data files
...
```sh
git clone https://github.com/ScopeFoundry/nomad-scopefoundry.git
cd nomad-scopefoundry
...
| Name | E-mail     |
|------|------------|
| Edward S. Barnard | [esbarnard@lbl.gov](mailto:esbarnard@lbl.gov)
